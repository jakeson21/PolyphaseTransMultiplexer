...
if __name__=="__main__":
    ...
    plot.tight_layout()
    pxx, freqs, bins, im = axarr1[0].specgram(data, NFFT=NFFT, Fs=FS, noverlap=NOVERLAP)
    ...
    pxx, freqs, bins, im = axarr1[2].specgram(basic, NFFT=NFFT, Fs=FS, noverlap=NOVERLAP)
    ...
    pxx, freqs, bins, im = axarr1[3].specgram(decimated, NFFT=NFFT, Fs=FS, noverlap=NOVERLAP)
    ...
    pxx, freqs, bins, im = axarr1[4].specgram(decimated_filtered, NFFT=NFFT, Fs=FS, noverlap=NOVERLAP)
    ...
    for i in range(decimated_filterbank.shape[0]):
        pxx, freqs, bins, im = axarr2[i].specgram(decimated_filterbank[i], NFFT=NFFT, Fs=FS, noverlap=NOVERLAP)
